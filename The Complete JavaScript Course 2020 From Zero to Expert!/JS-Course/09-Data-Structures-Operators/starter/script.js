...
// const uniqueArrayOfEvents = [...new Set(gameEvents.values())];
// console.log(uniqueArrayOfEvents);
...
btn.addEventListener('click', function () {
  ...
  for (const [i, s] of splitText.entries()) {
    ...
    let miniArray = newString.split(' ');
    miniArray[1] = miniArray[1][0].toUpperCase() + miniArray[1].slice(1);
    newString = `${miniArray[0]}${miniArray[1]}`;
    newString = newString.padEnd(20, ' ');
